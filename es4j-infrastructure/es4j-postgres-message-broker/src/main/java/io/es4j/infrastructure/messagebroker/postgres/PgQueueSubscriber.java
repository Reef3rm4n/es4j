...
import io.es4j.infrastructure.messagebroker.postgres.mappers.PgQueueLiquibase;
import io.es4j.infrastructure.messagebroker.postgres.models.*;
...
import io.es4j.infrastructure.messagebroker.QueueSubscriber;
...
public class PgQueueSubscriber implements QueueSubscriber {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(PgQueueSubscriber.class);

  public PgQueueSubscriber(Vertx vertx, JsonObject configuration) {

...
import io.es4j.infrastructure.messagebroker.postgres.PgRefresher;
import io.smallrye.mutiny.Uni;
import io.es4j.infrastructure.messagebroker.postgres.PgQueueSubscriber;
...
public class PgQueueLiquibase {
  ...
  public static Uni<Void> bootstrapQueue(final RepositoryHandler repositoryHandler, QueueConfiguration configuration) {
    if (PgQueueSubscriber.LIQUIBASE_DEPLOYED.compareAndSet(false, true)) {

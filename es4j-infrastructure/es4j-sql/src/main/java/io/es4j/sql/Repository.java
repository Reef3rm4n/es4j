...
public final class Repository<K extends RepositoryRecordKey, V extends RepositoryRecord<V>, Q extends io.es4j.sql.models.Query> implements RecordRepository<K, V, Q> {

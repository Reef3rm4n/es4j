...
import io.vertx.eventx.test.domain.behaviours.ChangedAggregator;
import io.vertx.eventx.test.domain.behaviours.CreateAggregator;
import io.vertx.eventx.test.domain.behaviours.CreateBehaviour;

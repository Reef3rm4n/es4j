...
import io.vertx.skeleton.taskqueue.postgres.mappers.PgQueueLiquibase;
import io.vertx.skeleton.taskqueue.postgres.models.*;
import io.smallrye.mutiny.Uni;
import io.vertx.core.impl.NoStackTraceThrowable;
import io.vertx.core.impl.logging.Logger;
import io.vertx.core.impl.logging.LoggerFactory;
import io.vertx.skeleton.taskqueue.TaskSubscriber;
...
public class PgTaskSubscriber implements TaskSubscriber {
  ...
  private Uni<List<MessageRecord>> pollBatch(TaskQueueConfiguration configuration, String deploymentId) {
    return messageQueue.query(pollingStatement(configuration, deploymentId)).onFailure(OrmNotFoundException.class)
      .recoverWithUni(

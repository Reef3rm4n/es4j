package io.vertx.eventx.test.infrastructure;

import io.vertx.eventx.InfrastructureBootstrap;
...
import static io.vertx.eventx.InfrastructureBootstrap.REPOSITORY_HANDLER;
...
public class LiquibaseTest {
  ...
  void test_queue_changelog(Vertx vertx, VertxTestContext vertxTestContext) {
    ...
    REPOSITORY_HANDLER.sqlClient().query("create schema if not exists testschema").execute()
      .await().indefinitely();

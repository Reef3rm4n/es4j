...
package io.vertx.skeleton.sql.misc;
...
public class EnvVars {
    ...
    public static final Boolean LIQUIBASE = Boolean.valueOf(System.getenv().getOrDefault("LIQUIBASE", "true"));
    ...
    public static final String SCHEMA = System.getenv().get("SCHEMA");

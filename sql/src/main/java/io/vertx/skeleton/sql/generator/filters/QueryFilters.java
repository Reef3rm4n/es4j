...
public class QueryFilters {
    ...
    public final List<Tuple3<String,String, List<?>>> jsonEqFilter;
    public final List<Tuple3<String,String, List<?>>> jsonLikeFilters;
    public final List<Tuple3<String,String, List<?>>> jsonILikeFilters;

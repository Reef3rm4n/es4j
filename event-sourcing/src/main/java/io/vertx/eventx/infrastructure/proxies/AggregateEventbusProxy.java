...
public class AggregateEventbusProxy<T extends Aggregate> {
  private final Vertx vertx;
  public final Class<T> entityClass;
  public static final Logger LOGGER = LoggerFactory.getLogger(AggregateEventbusProxy.class);

  public AggregateEventbusProxy(
    final Vertx vertx,
  ...
  public Uni<T> wakeUp(AggregateRecordKey key) {
    return request(
      vertx,
      entityClass,

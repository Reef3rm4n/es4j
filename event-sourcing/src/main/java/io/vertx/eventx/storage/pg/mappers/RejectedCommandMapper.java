...
import io.vertx.eventx.storage.pg.models.RejectedCommand;
import io.vertx.sqlclient.Row;
import java.util.Map;
import java.util.Set;

public class RejectedCommandMapper implements RecordMapper<AggregateKey, RejectedCommand, EmptyQuery> {

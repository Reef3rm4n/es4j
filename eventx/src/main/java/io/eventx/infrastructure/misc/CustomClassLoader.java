...
public class CustomClassLoader {
  ...
  public static final String PACKAGE_NAME = System.getenv().getOrDefault("PACKAGE_NAME", "io.eventx");
  public static final Reflections INTERNAL_REFLECTIONS = new Reflections("io.eventx");

...
import io.vertx.skeleton.ccp.consumers.TaskQueueHandler;
...
public class RabbitMQSubscriber<T, R> {
  ...
  private final TaskQueueHandler<T, R> taskWrapper;

  public RabbitMQSubscriber(final RabbitMQClient rabbitMQClient, final TaskQueueHandler<T, R> taskQueueHandler) {
    this.rabbitMQClient = rabbitMQClient;
    this.taskWrapper = taskQueueHandler;
  }

...
import io.eventx.sql.models.JsonQueryParam;
import io.eventx.sql.models.JsonQueryFilter;
import io.eventx.sql.models.QueryFilter;
...
public class QueryBuilder {
  ...
  public <T> QueryBuilder eq(io.eventx.sql.models.QueryFilters<T> queryFilters) {
    filters.eqFilters.add(Tuple2.of(queryFilters.column(), queryFilters.params()));
    return this;
  }

  public <T> QueryBuilder like(io.eventx.sql.models.QueryFilters<T> queryFilters) {
    filters.likeFilters.add(Tuple2.of(queryFilters.column(), queryFilters.params()));
    return this;
  }

  public <T> QueryBuilder iLike(io.eventx.sql.models.QueryFilters<T> queryFilters) {

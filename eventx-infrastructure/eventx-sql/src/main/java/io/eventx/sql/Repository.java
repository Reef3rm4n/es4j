...
import io.eventx.sql.commands.GenerateQueryCommand;
import io.eventx.sql.models.QueryStatementType;
import io.eventx.sql.models.RecordRepository;
...
public final class Repository<K extends RepositoryRecordKey, V extends RepositoryRecord<V>, Q extends io.eventx.sql.models.Query> implements RecordRepository<K, V, Q> {
